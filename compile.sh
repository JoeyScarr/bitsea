...
g++ -std=c++11 CommandLineParser.cpp TorrentFileParser.cpp Bencoding.cpp InfoParser.cpp Tracker.cpp BitSea.cpp -o bs -pthread -lcrypto -lcurlpp -lcurl -lboost_filesystem -lboost_system -lssl
